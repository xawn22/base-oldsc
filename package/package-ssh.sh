...
url1="app.servpanel.biz.id/shell"
url2="app.servpanel.biz.id/stunnel5"
url3="app.servpanel.biz.id/function"
url4="app.servpanel.biz.id/package"
url5="app.servpanel.biz.id/dll"
